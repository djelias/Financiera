@extends ('layout')
@section('header')
<header style="background-image: url('startbootstrap-clean-blog-gh-pages/assets/img/titulos.jpg'); opacity: 0.8;"><h2 style="color: white; font-family: sans-serif; font-size: 58px; text-align: center;">Categoria de cuentas</h2>
  </header>
@endsection
@section('container')
 <br>
  ...
  <div class="row">
     <div class="col-md-8">
        ...
        {{ Form::open(['route'=>'catcuenta.store', 'method'=>'POST', 'class'=>'agregar']) }}
    ...
    <div class="col-md-4">
        {!! Form::open(['route'=>'catcuenta.index', 'method'=>'GET', 'class'=>'navbar-form pull-right', 'role'=>'search'])!!}
      ...
      <div class="col-md-12" style="text-align:right;">
          <a href="catcuentaPrueba.pdf" class="btn-info btn-sm" target="_blank" >Generar PDF</a>
      </div>    
  </div>
  ...
  <table class="table table-striped" style="text-align:center" >
    ...
    <tr>
        ...
        <td>
          <a class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="top" title="Detalles" href="{{route('catcuenta.show',$value->id)}}">
              <i class="glyphicon glyphicon-list-alt">Detalles</i></a>
          @can('Editar Dominio')
          <a class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="top" title="Editar" href="{{route('catcuenta.edit',$value->id)}}">
              <i class="glyphicon glyphicon-pencil">Editar</i></a>
          @endcan
          @can('Eliminar Dominio')
            {!! Form::open(['method' => 'DELETE','route' => ['catcuenta.destroy', $value->id],'style'=>'display:inline', 'class'=>'formulario-eliminar']) !!}
