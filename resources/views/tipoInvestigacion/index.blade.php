@extends ('layout')
@section('header')
<header style="background-image: url('startbootstrap-clean-blog-gh-pages/assets/img/titulos.jpg'); opacity: 0.8;"><h2 style="color: white; font-family: sans-serif; font-size: 58px; text-align: center;">Tipos de investigacion</h2>
  </header>
@endsection
@section('container')
 <br>
  ...
  <div class="row">
     <div class="col-md-8">
        ...
        {{ Form::open(['route'=>'tipoInvestigacion.store', 'method'=>'POST', 'class'=>'agregar']) }}
  ...
  <table class="table table-striped" style="text-align:center" >
    ...
    <tr>
        ...
        <td>
          <a class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="top" title="Detalles" href="{{route('tipoInvestigacion.show',$value->id)}}">
              <i class="glyphicon glyphicon-list-alt">Detalles</i></a>
          <a class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="top" title="Editar" href="{{route('tipoInvestigacion.edit',$value->id)}}">
              <i class="glyphicon glyphicon-pencil">Editar</i></a>
            {!! Form::open(['method' => 'DELETE','route' => ['tipoInvestigacion.destroy', $value->id],'style'=>'display:inline', 'class'=>'formulario-eliminar']) !!}
...
$('.agregar').submit(function(e){
  ...
  title: '¿Está seguro de guardar este Tipo de investigacion?',
  showDenyButton: true,
...
$('.formulario-eliminar').submit(function(e){
     e.preventDefault();
       Swal.fire({
    title: '¿Está seguro de eliminar permanentemente este Tipo de investigacion?',
