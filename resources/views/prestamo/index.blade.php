  ...
  <table class="table table-striped" style="text-align:center" >
    ...
    <tr>
        ...
        <td>
          ...
          <a class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="top" title="Detalles" href="{{route('reportePre2',$value->id)}}">
              <i class="glyphicon glyphicon-list-alt">Reporte pagos</i></a>
